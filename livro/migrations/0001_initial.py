    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumb', models.ImageField(blank=True, null=True, upload_to=livro.models.upload_image_livro)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_cadastro', models.DateField(default=datetime.date.today)),
                ('isbn', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='livro.livro')),
                ('ra', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
